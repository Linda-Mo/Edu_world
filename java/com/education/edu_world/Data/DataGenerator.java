package com.education.edu_world.Data;
...
import com.education.edu_world.model.CardViewImg;
import com.education.edu_world.model.Image;
import com.education.edu_world.model.Inbox;
import com.education.edu_world.model.News;
import com.education.edu_world.model.People;
import com.education.edu_world.model.Social;
import com.education.edu_world.utils.Tools;
...
public class DataGenerator {
    ...
    public static List<Inbox> getInboxData(Context ctx) {
        ...
        for (int i = 0; i < drw_arr.length(); i++) {
            ...
            obj.message = ctx.getResources().getString(R.string.notification_setting_all_message);
